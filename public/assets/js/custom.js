...
(function ($) {
  ...
  *************************/
	...
	*************************/
    ...
    POTENZA.datetimepicker = function () {
        if ($(".datetimepickers").exists()) {
            $(
                "#datetimepicker-01, #datetimepicker-02, #datetimepicker-05, #datetimepicker-06, #datetimepicker-07, #datetimepicker-08, #datetimepicker-09, #datetimepicker-10, #datetimepicker-11, #datetimepicker-12, #datetimepicker-13, #datetimepicker-14"
            ).datetimepicker({
                format: "L",
            });
